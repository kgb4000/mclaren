    ...
    >
      <div className="container flex items-center justify-between">
        ...
        <nav
          ...
          } absolute left-0 right-0 top-full max-h-[calc(100vh-4.5rem-76px)] flex-col overflow-y-auto bg-black pb-8 pl-[1.2rem] pr-[1.2rem] pt-4 md:static md:flex md:max-h-none md:flex-row md:items-center md:gap-6 md:overflow-visible md:bg-transparent md:p-0`}
        >
